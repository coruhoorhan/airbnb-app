...
class MCPPreflightValidatorV6V2:
    """
    ...
    def __init__(
        ...
        """
        Initializes the MCPPreflightValidatorV6V2.
...
class PreflightMCPServerWrapperV6V2:
    """
    ...
    def __init__(self, server: MCPServer, validator: Optional[MCPPreflightValidatorV6V2] = None) -> None:
        """
        Initializes the PreflightMCPServerWrapperV6V2.

        Args:
            server (MCPServer): The MCPServer instance to wrap.
            validator (Optional[MCPPreflightValidatorV6V2]): The validator to use.
        """
        self.server = server
        self.validator = validator or MCPPreflightValidatorV6V2(registry=getattr(server.exporter, "registry", None))
