"""
Subagent Spawning and Context Compression V4.

This module provides the SubagentSpawnerV4 class which enables dynamic
subagent spawning for parallel execution with compressed context passing
to optimize token usage, inspired by the Claude Agent SDK and using
the AgentTeamManagerV4 for strict sandboxing and teardown.
"""
...
class SubagentSpawnerV4:
    ...
    Leverages AgentTeamManagerV4 for sandboxing and aggressive cleanup.
    """
    ...
    def __init__(
        ...
        """
        Initialize the SubagentSpawnerV4.
    ...
    def compress_context(self, context: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        ...
        # Naive compression logic: keep system prompt and last 4 messages
        if len(context) > 5:
